...
internal class ReadiumReaderView(
  ...
  init {
    ...
    readiumView = EpubNavigatorView(context, publication, initialLocator, this)
  ...
  private val isVerticalScroll: Boolean get() = userProperties?.get("--USER__scroll") == "readium-scroll-on"
